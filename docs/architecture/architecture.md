...
## Introduction
This project concerns the backend of a web application, for which a JavaScript client is planned.

The backend is written in Python, with the use of additional libraries written in C and Rust, such as Pydantic. The current Python version in use is 3.13. If compatibility issues arise, a downgrade to version 3.12 will be possible, although this is unlikely.
...
The following sections of this document contain information about:
  ...
  - justification and description of applied design patterns.
