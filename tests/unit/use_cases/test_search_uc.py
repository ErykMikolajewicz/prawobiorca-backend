...
#
# @pytest.mark.asyncio
# async def test_search_file_no_results(mock_embedding_port, mock_documents_repo):
#     query = "unknown query"
...
#
# @pytest.mark.asyncio
# async def test_search_file_embedding_error(mock_embedding_port, mock_documents_repo):
#     query = "error query"
...
#
# @pytest.mark.asyncio
# async def test_search_file_repository_error(mock_embedding_port, mock_documents_repo):
...
#         await use_case.execute(query=query, search_params=search_params)
#
#     mock_embedding_port.embed_queries.assert_awaited_once_with([query])
#     mock_documents_repo.search.assert_awaited_once_with(embedding_vector, search_params)
