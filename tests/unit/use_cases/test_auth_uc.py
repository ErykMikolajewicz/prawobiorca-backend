...
@pytest.mark.asyncio
async def test_log_user_success(mock_session, mock_users_repo, mock_tokens_repo, session_id_generator, uuid_generator):
...
async def test_logout_user(mock_session, mock_tokens_repo, session_id_generator):
    ...
    use_case = LogoutUser(session_id=session_id, session=mock_session, tokens_repo=mock_tokens_repo)
